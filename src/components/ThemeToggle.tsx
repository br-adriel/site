...
export default function ThemeToggle() {
  ...
  return (
    <div className='absolute top-1 right-2'>
      ...
      >
        <RadixSwitch.Thumb className='bg-siteBg-light dark:bg-siteBg-dark w-6 h-6 rounded absolute top-0.5 left-0.5 data-[state=checked]:left-auto data-[state=checked]:translate-x-3.5 transition-transform flex items-center justify-center shadow-sm'>
